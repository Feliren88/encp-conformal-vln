...
<p align="center">
  <img src="assets/fig_pipeline.png" alt="Pipeline: calibrate a normalised score on val-seen episodes (parameter-free or learned weight), take the episode-max quantile, then at test time act when the prediction set is small and ask a human when it is large." width="90%">
</p>
...
<p align="center">
  <img src="assets/fig_gap.png" alt="Step-averaged coverage clears the 0.90 target on all five backbones, while whole-trajectory coverage falls to 0.82-0.89 under the seen-to-unseen scene shift." width="55%">
</p>
...
<p align="center">
  <img src="assets/fig_closedloop.png" alt="Success rate versus ask rate for set-size and confidence triggers: the conformal set-size trigger traces the efficient frontier." width="55%">
</p>
...
<p align="center">
  <img src="assets/fig_qualitative.png" alt="A single val-unseen episode: per-step prediction sets stay small on confident steps and widen exactly at the ambiguous junction." width="80%">
</p>
...
paper_figures.py            regenerates the paper figures from results/
...
The LaTeX write-up is kept offline and is not distributed with this
repository. Every table number and figure in it is generated by the code here
(`analyze` → `paperfigs` → `tables`) and machine-checked by `verify`.
...
@misc{conformal-vln,
  ...
  year   = {2026},
  note   = {Under review},
  url    = {https://github.com/Feliren88/encp-conformal-vln}
}
```
